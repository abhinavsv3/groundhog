...
**Status: 78 attempts recorded across 3 models**
(`llama3.1`, `qwen2.5-coder:7b`, `qwen3:8b`).
...
| model | n | solved (95% CI) | met F2P | collateral | tampered | min/attempt |
|---|---|---|---|---|---|---|
| `qwen3:8b` | 38 | **45% (30–60)** | 17 | 0 | 0 | 9.3 |
| `qwen2.5-coder:7b` | 38 | **8% (3–21)** | 6 | 3 | 0 | 0.9 |
| `llama3.1` | 2 | **0% (0–66)** | 0 | 0 | 0 | 1.1 |
...
| repo | `llama3.1` | `qwen2.5-coder:7b` | `qwen3:8b` |
|---|---|---|---|
| `click` | -- | 0/8 | 0/8 |
| `gotoolbox` | -- | 1/6 | 5/6 |
| `httpx` | -- | 0/8 | 0/8 |
| `jstoolbox` | -- | 1/4 | 3/4 |
| `toolbox` | 0/2 | 1/12 | 9/12 |
